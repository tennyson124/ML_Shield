...
def demo(sess, net, image_name):
    ...
    # Load the demo image
    im_file = os.path.join('demo_img', image_name)
...
if __name__ == '__main__':
    ...
    for file in os.listdir("./demo_img"):
        if file.endswith(".jpg"):
            print('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
            print('Demo for demo_img/{}'.format(file))
            demo(sess, net, file)
